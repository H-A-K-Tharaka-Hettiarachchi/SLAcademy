...
if (isset($_SESSION["academic_officer"])) {
    $rs = Database::search("SELECT * FROM `academic_officer` WHERE `email`='" . $_SESSION["academic_officer"]["email"] . "'");
    $data = $rs->fetch_assoc();
} else {
    $data = "";
}
        ...
        <div class="row">
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 offset-lg-3 bg-body mt-3 mb-5 rounded shadow">
                        <div class="row">
                            ...
                            <div class="col-12  bg-secondary">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-3 mb-5 text-center">
                                        <div class="row">
                                            <label class="form-label fs-4 fw-bold bg-info">Academic Officer Login</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-8 offset-2 mt-5 mb-5">
                                        ...
                                        if (isset($_SESSION["academic_officer"])) {
                                        ?>
                                            <input type="text" class="form-control" id="aoun" value="<?php echo $data["user_name"]; ?>">
                                        <?php
                                        } else {
                                        ?>
                                    ...
                                    <div class="col-8 offset-2 mt-5 mb-5">
                                        ...
                                        if (isset($_SESSION["academic_officer"])) {
                                        ?>
                                            <input type="password" class="form-control" id="aop" value="<?php echo $data["password"]; ?>">
                                        <?php
                                        } else {
                                        ?>
                                    ...
                                    $aors = Database::search("SELECT * FROM `academic_officer` WHERE  `user_name`='" . $_SESSION["academic_officer"]["user_name"] . "' AND `password`='" . $_SESSION["academic_officer"]["password"] . "' ");
                                    ...
                                    ?>
                                        ...
                                        <div class="col-8 offset-2  mb-5 d-grid">
                                            <button class="btn btn-primary" onclick="aoVcSend();">Send Verification Code</button>
                                        </div>

                                        <div class="col-8 offset-2  mb-5">
                                            <label class="form-label fw-bold">Verification Code</label>
                                            <input type="password" class="form-control" id="aovc">
                                        </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4 offset-1 d-grid">
                                                            <button class="btn btn-success" onclick="aoLogin();">Verify</button>
                                                        </div>
                                                        <div class="col-4 offset-1 d-grid">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4 offset-1 d-grid">
                                                            <button class="btn btn-success" onclick="aoLogin2();">Log In</button>
                                                        </div>
                                                        <div class="col-4 offset-1 d-grid">
                                                            <button class="btn btn-danger" onclick="window.location='index.php';">Back To Login Selection</button>
                                                        </div>
