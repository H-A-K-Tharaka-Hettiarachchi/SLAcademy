            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12 mb-5">
                        <div class="row">
                            <div class="col-12 title3 bg-info text-center">Teacher Registration</div>
                        </div>
                    </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        ...
                                                                        <select name="gender" id="g" class="form-select" id="g">
                                                    ...
                                                    <div class="col-6 mt-3">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                ...
                                                                <select name="gender" class="form-select" id="s">
                                                            ...
                                                            <div class="col-6 offset-3 mt-5">
                                                                <div class="row">
                                                                    <div class="col-12 d-grid">
                                                                        <button class="btn btn-success" onclick="tRegister();">Register</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
