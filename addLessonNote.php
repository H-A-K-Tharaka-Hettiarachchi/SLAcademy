                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-12  text-white fw-bold mt-5 mb-3">
                                                                                        <label class="form-label fs-3">Add Lesson Notes</label>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-10 offset-1">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-2 offset-0 fw-bold text-white text-center mt-5 mb-5  rounded cursor">
                                                                                                ...
                                                                                                <label for="f" class="form-label fs-4 cursor rounded rounded-5 btn btn-outline-warning" onclick="addLessonFile();">
                                                                                                    ...
                                                                                                    <div class="col-6 offset-3">
                                                                                                        <div class="row">
                                                                                                            <div class="col-12 d-grid">
                                                                                                                <button class="btn btn-success fs-5" onclick="addLessonNote('<?php echo $data['email']; ?>');">Submite</button>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
