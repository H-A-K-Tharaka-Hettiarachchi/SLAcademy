                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 mt-3 mb-5 text-white">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-4 col-lg-4 col-xl-4 fs-6 fw-bold border-1 border-bottom border-white border-end">Lesson Name</div>
                                                                    ...
                                                                    $lrs = Database::search("SELECT * FROM `student` INNER JOIN `lesson_note` ON student.grade_id =lesson_note.grade_id INNER JOIN `subject` ON
                                                                         lesson_note.subject_id=subject.id INNER JOIN `grade` ON student.grade_id=grade.id WHERE student.grade_id='" . $data["grade_id"] . "' ");
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <div class="col-4 col-lg-4 col-xl-4 border-1 border-bottom border-white border-end"><?php echo $ldata["lesson_name"]; ?></div>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="row">
                                                                                    <div class="col-12 d-grid">
                                                                                        <a href="<?php echo $ldata["path"]; ?>" target="_blank"  class="btn btn-danger badge">View</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
