                                                                                            ...
                                                                                            ?>
                                                                                                ...
                                                                                                <div class="col-3 col-lg-2  col-xl-2 border-1 border-bottom border-white d-grid">
                                                                                                    <div class="row">
                                                                                                        <div class="col-12">
                                                                                                            <div class="row">
                                                                                                                <div class="col-6 d-grid"><button class="btn badge rounded-pill text-bg-success">Update</button></div>
                                                                                                                <div class="col-6 d-grid"><button class="btn badge rounded-pill text-bg-danger">Delete</button></div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
