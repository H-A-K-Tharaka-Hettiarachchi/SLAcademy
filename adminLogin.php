...
<hr>
                    <div class="col-12 bg-info mb-5">
                        <div class="row">
                            ...
                            <div class="title1 col-5 offset-3 text-center mb-3 mt-3">~SL Academi~</div>
                            ...
                            <div class="col-12  bg-secondary">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-3 mb-5 text-center">
                                        <div class="row">
                                            <label class="form-label fs-4 fw-bold bg-info">Admin Login</label>
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-8 offset-2  mb-5 d-grid">
                                    <button class="btn btn-primary" onclick="sendAdminVerificationCode();">Send Verification Code</button>
                                   </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="col-4 offset-1 d-grid">
                                                <button class="btn btn-success" onclick="adminVerify();">Verify</button>
                                            </div>
                                            <div class="col-4 offset-1 d-grid">
